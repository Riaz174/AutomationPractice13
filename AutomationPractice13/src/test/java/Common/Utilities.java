...
public class Utilities {
  ...
  public void Browsers(String browsers, String Wbsite) {
	  if(browsers.equalsIgnoreCase("Chrome")) {
		  ...
		  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository30\\AutomationPractice13\\Drivers\\msedgedriver.exe");
  ...
  public void shots() throws IOException {
	  ...
	  FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository30\\AutomationPractice13\\Pictures\\"+sd+"pictureOfwebsite.jpg"));
  }
